...
\method{} generalises well to VisA, achieving 90.3\% I-AUROC with even lower forgetting (0.52\%). The performance gap between MVTec AD and VisA reflects the inherent difficulty of the VisA benchmark rather than a limitation of the method.
